...
export function getPortfolioData(i18n: Record<string, string>) {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      result: 'Plataforma centralizada que facilita toda la gestión de la operación diaria de ollas comunes, mejorando la eficiencia y coordinación entre organizaciones.',
      techs: 'React | Next.js | TypeScript | Tailwind CSS | shadcn/ui | Sonner | PostgreSQL',
      image: '/projects/ollas-comunes.png',
      demo: '/projects/demos/ollas-demo/index.html',
      repo: '#',
      featured: false,
    },
    {
      id: 'gestionalo',
      title: 'Gestionalo CMS',
      problem: 'Empresa de arquitectura legal e inspección técnica necesitaba un CMS moderno para gestionar contenido web, agendar citas y publicar artículos sin conocimientos técnicos.',
      desc: 'Gestionalo es un CMS construido con Laravel 11 y Livewire 3 que permite la gestión dinámica de contenido: servicios, proyectos, blog con categorías y sistema de citas nativo. Incluye un asistente de IA integrado (Gemini API) para resumir artículos mediante texto a voz y generación automática de resúmenes ejecutivos. La arquitectura incluye cifrado en reposo, auditoría WORM, rate limiting y políticas por modelo.',
      result: 'Plataforma completa de gestión de contenido con IA integrada, sistema de citas nativo y panel administrativo en tiempo real.',
      techs: 'Laravel 11 | Livewire 3 | Alpine.js | Tailwind CSS | PostgreSQL | PHP 8.2 | Docker | Gemini AI',
      image: '/projects/gestionalo.png',
      demo: '/projects/demos/gestionalo-demo/demo.html',
      repo: '#',
      featured: false,
    },
    {
      id: 'cosmetologia-yvette',
      title: 'Centro de Estética Yvette',
      problem: 'Centro de estética con más de 15 años de experiencia necesitaba una presencia web moderna y un panel administrativo mobile-first para gestionar citas, servicios e inventario.',
      desc: 'Landing page responsiva con secciones de servicios, información del centro, equipo de especialistas y accesos directos. Panel administrativo mobile-first con tarjetas apiladas, cambio de pestañas interactivo (Dashboard, Citas, Servicios, Inventario) y métricas simuladas. Diseñado para demostraciones rápidas sin backend ni base de datos.',
      result: 'Landing page profesional + panel administrativo funcional para gestión del centro de estética.',
      techs: 'HTML5 | CSS3 | JavaScript | Mobile-first Design',
      image: '/projects/cosmetologia-yvette.png',
      demo: '/projects/demos/cosmetologia-yvette/index.html',
      repo: '#',
      featured: false,
    },
  ];
